...
const SocialLogin = () => {
  ...
  return (
    <div className="flex gap-5 flex-wrap px-3 -mx-3 sm:px-6 xl:px-12">
      <div className="w-3/12 max-w-full px-1 ml-auto flex-0">
        <button className="inline-block px-6 py-3 mb-4 font-bold text-center text-gray-200 uppercase align-middle transition-all bg-transparent border border-gray-200 border-solid rounded-lg shadow-none cursor-pointer hover:scale-102 text-xs bg-150 bg-x-25 hover:bg-transparent hover:opacity-75">
          <svg
            width="24px"
            height="32px"
            viewBox="0 0 64 64"
      ...
      <div className="relative w-full max-w-full px-3 mt-2 text-center shrink-0">
        <p className="z-20 inline px-4 mb-2 font-semibold leading-normal bg-white text-lg text-slate-400">
          or
        </p>
      </div>
    </div>
